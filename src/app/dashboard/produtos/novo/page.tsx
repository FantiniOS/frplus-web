...
export default function NovoProdutoPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const newProduct: Product = {
            ...
            fabricaId: formData.fabricaId || '',
            imagemUrl: formData.imagemUrl || '',
            preco50a199: Number(formData.preco50a199) || 0,
            preco200a699: Number(formData.preco200a699) || 0,
                ...
                <div className="form-card">
                    ...
                    <div className="grid gap-3 grid-cols-2">
                        <div>
                            ...
                            <input name="codigo" onChange={handleChange} placeholder="PROD-001" className="input-compact" />
                        </div>
                        <div>
                            <label className="label-compact">Nome *</label>
                            <input name="nome" onChange={handleChange} className="input-compact" />
                        </div>
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select name="fabricaId" onChange={handleChange} className="input-compact pl-7">
                        ...
                        <div>
                            ...
                            <input name="categoria" onChange={handleChange} placeholder="Bebidas" className="input-compact" />
                        </div>
                        <div>
                            <label className="label-compact">Unidade</label>
                            <select name="unidade" onChange={handleChange} className="input-compact">
                ...
                <div className="form-card">
                    ...
                    <div className="grid gap-3 grid-cols-5">
                        <div>
                            ...
                            <input name="preco50a199" type="number" step="0.01" onChange={handleChange} placeholder="0.00" className="input-compact" />
                        </div>
                        <div>
                            <label className="label-compact">200 a 699 CX</label>
                            <input name="preco200a699" type="number" step="0.01" onChange={handleChange} placeholder="0.00" className="input-compact" />
                        </div>
                        <div>
                            <label className="label-compact">Atacado</label>
                            <input name="precoAtacado" type="number" step="0.01" onChange={handleChange} placeholder="0.00" className="input-compact" />
                        </div>
                        <div>
                            <label className="label-compact">Atacado à Vista</label>
                            <input name="precoAtacadoAVista" type="number" step="0.01" onChange={handleChange} placeholder="0.00" className="input-compact" />
                        </div>
                        <div>
                            <label className="label-compact">Redes</label>
                            <input name="precoRedes" type="number" step="0.01" onChange={handleChange} placeholder="0.00" className="input-compact" />
                        </div>
                    </div>
                </div>
            </form>
