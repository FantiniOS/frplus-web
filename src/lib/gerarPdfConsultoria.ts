...
export async function gerarPdfConsultoria(payload: PayloadConsultoria) {
    try {
        ...
        autoTable(doc, {
            startY,
            head: [['Produto', 'Vol. (CX)', 'Cobertura', 'Custo NF', 'Custo Real', colunaPrecoLabel, 'Margem', 'Lucro Proj.']],
            body: tableBody,
            theme: 'striped',
            tableWidth: 'wrap',
            styles: { fontSize: 7, cellPadding: 2, halign: 'left', lineColor: colors.tableBorder, lineWidth: 0.2, overflow: 'ellipsize' },
            headStyles: { fillColor: colors.headerDark, textColor: 255, fontStyle: 'bold', cellPadding: 3, halign: 'left', fontSize: 6.5 },
            alternateRowStyles: { fillColor: colors.rowEven },
            columnStyles: {
                0: { fontStyle: 'bold', textColor: colors.textDark, cellWidth: 80 },
                1: { halign: 'center', textColor: colors.textMuted, cellWidth: 18 },
                ...
                5: { halign: 'right', textColor: colors.accentBlue, fontStyle: 'bold', cellWidth: 34 },
