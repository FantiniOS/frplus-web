...
export async function gerarPdfConsultoria(payload: PayloadConsultoria) {
    try {
        ...
        autoTable(doc, {
            ...
            theme: 'striped',
            tableWidth: 'auto',
            styles: { fontSize: 7.5, cellPadding: 2.5, halign: 'left', lineColor: colors.tableBorder, lineWidth: 0.2, overflow: 'linebreak' },
            ...
            columnStyles: {
                0: { fontStyle: 'bold', textColor: colors.textDark, cellWidth: 95 },
                1: { halign: 'center', textColor: colors.textMuted, cellWidth: 20 },
                2: { halign: 'center', textColor: colors.textMuted, cellWidth: 22 },
                3: { halign: 'right', textColor: colors.textMuted, cellWidth: 26 },
                4: { halign: 'right', textColor: colors.orangeAccent, fontStyle: 'bold', cellWidth: 26 },
